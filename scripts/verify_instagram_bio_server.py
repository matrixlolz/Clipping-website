#!/usr/bin/env python3
"""
HTTP Server for Instagram Bio Verification
...
from verify_instagram_bio import fetch_instagram_bio


class InstagramBioHandler(BaseHTTPRequestHandler):
    """HTTP request handler for Instagram bio verification."""
...
def run_server(port: int = 8000):
    """Run the HTTP server."""
    server_address = ('', port)
    httpd = HTTPServer(server_address, InstagramBioHandler)
    print(f'Instagram Bio Verification Server running on port {port}')
