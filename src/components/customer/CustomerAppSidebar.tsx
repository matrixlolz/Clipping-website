...
import { Home, Search, User, DollarSign, Settings, Smartphone } from "lucide-react";
...
export function CustomerAppSidebar() {
  ...
  const { profile, user, role, isLoading: authLoading } = useAuth();
  ...
  const homeUrl = experienceId ? `/experiences/${experienceId}/home` : "/";
...
export default CustomerAppSidebar;
